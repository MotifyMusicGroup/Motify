...
* Update translations see [translation_process.md](https://github.com/Toran/TNX/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Toran Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [TNX-detached-sigs](https://github.com/Toran/TNX-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the Toran.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Toran/TNX/releases/new) with a link to the archived release notes.

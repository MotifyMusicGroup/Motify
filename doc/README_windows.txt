...
Intro
-----
MDFY (MDFY) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MDFY utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run MDFY-qt.exe.

Motify Core is the original MDFY client and it builds the backbone of the network.
However, it downloads and stores the entire history of MDFY transactions;

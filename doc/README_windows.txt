...
Intro
-----
TNX (TNX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. TNX utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run TNX-qt.exe.

Toran Core is the original TNX client and it builds the backbone of the network.
However, it downloads and stores the entire history of TNX transactions;

...
In order to support loading of multiple wallets in MDFY-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MDFY.cpp.
...
Changes to MDFY.cpp
----------------------
MDFY.cpp is the entry point into MDFY-qt, and as such, will require some minor modifications to provide hooks for

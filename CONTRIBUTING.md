Contributing to Toran Core
==================================

The Toran Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Toran Core project, and is not to be
confused with overall TNX Network Protocol consensus changes.

Whether a pull request is merged into Toran Core rests with the project merge
...
Patches that change TNX consensus rules are considerably more involved than
...
Where a patch set proposes to change the TNX consensus, it must have been
...
The project leader is the release manager for each Toran Core release.

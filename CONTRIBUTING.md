Contributing to Motify Core
==================================

The Motify Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Motify Core project, and is not to be
confused with overall MDFY Network Protocol consensus changes.

Whether a pull request is merged into Motify Core rests with the project merge
...
Patches that change MDFY consensus rules are considerably more involved than
...
Where a patch set proposes to change the MDFY consensus, it must have been
...
The project leader is the release manager for each Motify Core release.

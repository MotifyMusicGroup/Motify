...
#   c) node1 mines 32 blocks, so now node 0 has 500000TNX, node 1 has 4250TNX, node2 has none.
#   d) node0 sends 601 TNX to node2, in two transactions (301 TNX, then 300 TNX).

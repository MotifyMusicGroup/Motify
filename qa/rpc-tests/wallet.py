...
#   c) node1 mines 32 blocks, so now node 0 has 500000MDFY, node 1 has 4250MDFY, node2 has none.
#   d) node0 sends 601 MDFY to node2, in two transactions (301 MDFY, then 300 MDFY).

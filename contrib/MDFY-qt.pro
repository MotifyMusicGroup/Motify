...
RESOURCES += src/qt/MDFY.qrc src/qt/MDFY_locale.qrc

TRANSLATIONS += src/qt/locale/MDFY_bg.ts \
                src/qt/locale/MDFY_de.ts \
                src/qt/locale/MDFY_en.ts \
                src/qt/locale/MDFY_es.ts \
                src/qt/locale/MDFY_fi.ts \
                src/qt/locale/MDFY_fr.ts \
                src/qt/locale/MDFY_it.ts \
                src/qt/locale/MDFY_ja.ts \
                src/qt/locale/MDFY_pl.ts \
                src/qt/locale/MDFY_pt.ts \
                src/qt/locale/MDFY_ru.ts \
                src/qt/locale/MDFY_sk.ts \
                src/qt/locale/MDFY_sv.ts \
                src/qt/locale/MDFY_vi.ts \
                src/qt/locale/MDFY_zh_CN.ts \
                src/qt/locale/MDFY_zh_TW.ts

...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"TNXaddress\"\n"
            "\nReturn information about the given TNX address.\n"
            "\nArguments:\n"
            "1. \"TNXaddress\"     (string, required) The TNX address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"TNXaddress\", (string) The TNX address validated\n"

...
/* MDFY GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MDFY"
#define QAPP_ORG_DOMAIN "Motify.com"
#define QAPP_APP_NAME_DEFAULT "MDFY-Qt"
#define QAPP_APP_NAME_TESTNET "MDFY-Qt-testnet"

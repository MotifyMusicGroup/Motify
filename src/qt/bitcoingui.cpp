                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Motify Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MDFY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MDFY: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Motify Core"), this);
    aboutAction->setStatusTip(tr("Show information about Motify Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MDFY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MDFY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MDFY addresses"));
    ...
    openAction->setStatusTip(tr("Open a MDFY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Motify Core help message to get a list with possible MDFY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Motify Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MDFY network", "", count));
}
...
{
    QString strTitle = tr("Motify Core"); // default title

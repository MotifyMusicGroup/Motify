...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Motify Core MDFY-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MDFY-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MDFY transaction") + "\n" +
                               "  MDFY-tx [options] -create [commands]   " + _("Create hex-encoded MDFY transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MDFY transaction
